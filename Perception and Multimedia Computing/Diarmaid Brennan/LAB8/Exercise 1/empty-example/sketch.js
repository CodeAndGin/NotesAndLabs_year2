function setup() {
  ...
  stroke(255, 0, 0);
  for (var t = 0; t < 500; t++) {
     var sin1_t = 100 * sin(TWO_PI*(1/500)*t); //Replace the "0" with the correct sine equation
  ...
  stroke(0, 255, 0);
  for (var t = 0; t < 500; t++) {
     var sin3_t = 200 * sin(TWO_PI * (3/500) * t);  //Replace the "0" with the correct sine equation
     point(t, sin3_t); //We plot 500 - sin1_t because in Processing, y gets bigger as you go DOWN
  }
